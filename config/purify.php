    ...
    */
    ...
    'configs' => [
        ...
        'trix' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h1[class],h2[class],h3[class],h4[class],h5[class],h6[class],b,u,strong,i,em,s,del,a[href|title|target|rel|class],ul[class],ol[class],li[class],p[style|class],br,span[style|class],img[width|height|alt|src|class],blockquote[class],figure[class],figcaption[class],pre[class],code[class],sub,sup,div[class],table[class],thead,tbody,tr,th[class],td[class]',
            'HTML.ForbiddenElements' => 'script,style,iframe,object,embed,form,input,textarea,select,button',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align,margin,margin-left,margin-right,width,height',
            'AutoFormat.AutoParagraph' => false,
            'AutoFormat.RemoveEmpty' => false,
