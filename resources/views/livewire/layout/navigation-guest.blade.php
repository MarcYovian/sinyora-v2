...
<nav x-data="{ mobileMenuOpen: false, scrolled: false }"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="{{ route('home.index') }}" wire:navigate class="flex items-center space-x-3 focus:outline-none focus:ring-2 focus:ring-[#FEC006] focus:ring-offset-2 rounded-md">
                    ...
                    <div x-show="openDropdown"
                        ...
                        <x-dropdown-link href="{{ route('home.index') }}#jadwal-misa" wire:navigate class="group">
                            <div class="flex items-center space-x-3">
                                <div class="p-1 rounded-lg bg-[#FEC006]/10 group-hover:bg-[#FEC006]/20 transition-colors">
                        ...
                        <x-dropdown-link href="#" wire:navigate class="group">
                            <div class="flex items-center space-x-3">
                                <div class="p-1 rounded-lg bg-[#FEC006]/10 group-hover:bg-[#FEC006]/20 transition-colors">
    ...
    <div x-show="mobileMenuOpen"
         ...
         class="md:hidden bg-white/95 backdrop-blur-lg shadow-xl"
         x-cloak>
